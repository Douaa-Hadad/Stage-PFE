...
def create_evaluation_notebook():
    notebook_path = Path("notebooks/04_evaluation.ipynb")
    output_path = Path("models/evaluation")
    ...
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## Section 1 — Load Everything"]
    })
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## Section 2 — Demand Prediction Evaluation"]
    })
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## Section 3 — Anomaly Detection Evaluation"]
    })
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## Section 4 — Alert Classification Evaluation"]
    })
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## Section 6 — Feature Importance (Permutation)"]
    })
    cells.append({
        "cell_type": "code",
        "execution_count": None,
    ...
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## Section 7 — Final Scorecard"]
    })
    cells.append({
        "cell_type": "code",
        "execution_count": None,
